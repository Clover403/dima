        ...
        <div className="sticky top-0 h-screen w-full overflow-hidden">
          ...
          <div className="absolute inset-0 z-50 pointer-events-none">
            {chapters.map((ch, i) => {
              ...
              const isCentered = i === 3 || i === 4; // Target teks tengah bawah
              ...
              // HANYA isCentered (tengah bawah) yang dilebarkan. Sisanya dikembalikan ke aslinya.
                ...
                >
                  ...
                  <AnimatePresence>
                    {isExpanded && ch.body && (
                      ...
                      >
                        <p
                          className="font-body text-[1.25rem] sm:text-[1.5rem] md:text-[1.75rem] lg:text-[2rem] font-medium leading-tight w-full break-words mt-3 pb-1 whitespace-pre-line"
