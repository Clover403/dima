const STATS = [
  { value: 'SOFOM', sub: 'E.N.R.', label: 'Entidad Financiera Regulada', mono: true },
  { value: '6', sub: null, label: 'Productos de crédito especializados', mono: false },
  { value: '6', sub: null, label: 'Servicios de consultoría estratégica', mono: false },
  { value: '360°', sub: null, label: 'Análisis macroeconómico integral', mono: false },
];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 md:gap-24 items-center">
          ...
          <div className="flex flex-col items-center gap-8">
            <div className="relative w-full max-w-[380px] aspect-square">
              ...
              <svg
                className="compass-svg w-full h-full"
                viewBox="0 0 200 200"
                fill="none"
              >
                {/* Outer rings */}
                ...
                {/* Bronze star/compass rose */}
                <path
                  d="M100 18 L106 90 L180 100 L106 110 L100 182 L94 110 L20 100 L94 90 Z"
                  stroke="#E5997B"
                  strokeWidth="0.7"
                  strokeOpacity="0.45"
                  fill="none"
                ...
                {/* Diagonal rose arms */}
                <path
                  d="M148 52 L108 96 M52 52 L92 96 M52 148 L92 104 M148 148 L108 104"
                  stroke="#E5997B"
                  strokeWidth="0.4"
                  strokeOpacity="0.25"
                />
          ...
          <div className="flex flex-col divide-y divide-[#030035]/6">
            {STATS.map((stat, i) => (
              <div
                key={i}
                className="stat-item group py-8 flex items-start gap-8"
              >
                {/* Line accent */}
                ...
                <div className="flex flex-col gap-2">
                  <div className="flex items-baseline gap-2">
                    <span
                      ...
                      style={stat.mono ? { fontFamily: "'Inter Tight', monospace", fontSize: 'clamp(2rem,5vw,3rem)', letterSpacing: '-0.02em' } : {}}
                    >
                      {stat.value}
                    </span>
                    {stat.sub && (
                      <span className="font-mono text-[10px] text-[#E5997B]/60 tracking-widest">
                        {stat.sub}
                      </span>
                    )}
                  </div>
                  <p
                    className="text-[#030035]/35 text-xs leading-relaxed font-light"
                ...
                {/* Index */}
                <div className="ml-auto pt-3 font-mono text-[8px] text-[#030035]/15 tracking-[0.3em]">
