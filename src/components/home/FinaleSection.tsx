...
const counters = [
  {
    ...
    suffix: "M",
    prefix: "+",
    label: "Capital estructurado (MXN)",
  },
...
function AnimatedCounter({
  ...
  return (
    <div className="text-center px-4">
      ...
      <p className="font-body text-sm md:text-base text-navy/50 tracking-wide">
        {label}
      </p>
    </div>
  );
      ...
      <div className="bg-lightgray px-8 md:px-16 lg:px-24 py-16">
        ...
        >
          ...
          <div className="absolute inset-0 opacity-[0.08] pointer-events-none">
            ...
            >
              <path
                d="M400 0L800 200L400 400L0 200Z"
                stroke="#030035"
                strokeWidth="1"
              />
              <path
                d="M400 50L750 200L400 350L50 200Z"
                stroke="#030035"
                strokeWidth="0.5"
              />
            </svg>
