...
export default function Navbar() {
  ...
  // Determine if current page has dark hero (Sekarang disamakan semua tanpa pengecualian)
    ...
    >
      <div className="section-padding flex items-center justify-between h-20">
        ...
        <Link to="/" className="relative z-50">
          <img
            src={scrolled ? '/logo/orange_black.svg' : isDarkHero ? '/logo/orange_white.svg' : '/logo/orange_black.svg'}
            alt="DIMA Finance"
        ...
        >
          <span
            className={`block w-6 h-px transition-all duration-300 ${
              scrolled ? 'bg-navy' : isDarkHero ? 'bg-lightgray' : 'bg-navy'
