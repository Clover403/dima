...
const N = '#030035'   // Navy (Deep Shadows, Outlines, Etching)
const S = '#E5997B'   // Bronze (Midtones, Texture, Accents)
const W = '#FFFFFF'   // White (Highlights, Base)
...
export function ProductPointIcon({ index = 0, drawProgress = 1 }: ProductPointIconProps) {
  ...
  return (
    <div ref={containerRef} className="relative w-full h-auto flex justify-center items-center p-4">
      <EngravingAssets />
      
      <div 
        className="relative w-[85vw] max-w-[800px] md:w-[50vw] h-auto drop-shadow-xl aspect-square"
